      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Choose the best car for destination.</h1>
            <h6>Choose from a wide variety of brands.</h6>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Has a restaurant on the other side of Richardson caught your eye? Do you have to get to a conference on the other side of town? Don't miss out on one of Richardson must-see attractions or be late to a meeting. When you have access to your own vehicle, you can make sure your visit is following your schedule, and not have to adhere a train schedule. Browse our choice of automobiles from some of the top car rental agencies in the nation and select the ideal automobile for your Richardson vacation!</p>
    </div>
    <div class="row"> 
